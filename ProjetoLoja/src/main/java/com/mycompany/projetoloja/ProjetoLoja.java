            ...
            switch (opcao) {
                ...
                case 6:
                    ...
                    do {
                        System.out.println("Insira o ID do produto: ");
                        int idProdutoPedido = ler.nextInt();
                        Produto produtoPedidoRemover = null;
                        for (Produto produto : loja.listarProdutos()) {
                            if (produto.getId() == idProdutoPedido) {
                                produtoPedidoRemover = produto;
                                break;
                            }
                        }
                        if (produtoPedidoRemover == null) {
                            System.out.println("Produto não encontrado.");
                            break;
                        }
                        loja.removerProduto(produtoPedidoRemover);
                ...
                case 7:
                    ...
                    do {
                        ...
                        int idClienteRemover = ler.nextInt();
                        Cliente clientePedidoRemover = null;
                        for(Cliente cliente  : loja.listarClientes()){
                            if(cliente.getId() == idClienteRemover){
                                clientePedidoRemover = cliente;
                                break;
                            }
                        }
                        if(clientePedidoRemover == null){
                            System.out.println("Cliente não encontrado.");
                            break;
                        }
                        loja.removerCliente(clientePedidoRemover);
